...
const RAW=[
 ...
 ["bodyweight-squat","Bodyweight Squat","Quads",["Quads","Glutes"],"Bodyweight",C,[12,25],"Feet shoulder-width, sit the hips back and down until the thighs are at least parallel, then stand tall. Arms forward for balance.","air squat,squat,squats,bw squat,body weight squat,no equipment squat"],
...
const META={
 ...
 'back-squat':['overall','squat',1],'front-squat':['overall','squat',1],'leg-press':['overall','squat',1],'hack-squat':['overall','squat',2],'goblet-squat':['overall','squat',2],'bodyweight-squat':['overall','squat',3],'bulgarian-split-squat':['overall','lunge',2],'walking-lunge':['overall','lunge',2],'leg-extension':['overall','iso',3],
